...
if __name__ == '__main__':
    ...
    # model = torch.load('E:\VIRI\mycode\\trained_model/f_s_7/6UnMSE/model_050.pth')#论文中放的

    model=torch.load('../../model_zoo/MSE-Unet-g30/model_050.pth')
    ...
    if args.save_result:
        ...
        # sio.savemat(('../../output/results/salt_sc100_' + 'MSE(unet-g30)' + '_dn.mat'),
        #             {'data': x_[:, :]})
        # n_=y-x_
        # sio.savemat(('../../output/results/salt_sc100_' + 'MSE(unet-g30)' + '_n.mat'),
        #             {'data': n_[:, :]})
