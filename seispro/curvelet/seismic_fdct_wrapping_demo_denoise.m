...
% n = size(img,1);
[img,SegyTraceHeaders1,SegyHeader1]=ReadSegy('E:\VIRI\paper\1stPaperSE\revise\output\salt_35.sgy');
dtsec = SegyTraceHeaders1(1).dt/1000/1000/4; 
...
subplot(2,2,1); imagesc(img); colormap seismic; axis('image');%colormap gray
subplot(2,2,2); imagesc(noisy_img); colormap seismic; axis('image');
subplot(2,2,3); imagesc(restored_img); colormap seismic; axis('image');
subplot(2,2,4); imagesc(noisy_img-restored_img); colormap seismic; axis('image');
