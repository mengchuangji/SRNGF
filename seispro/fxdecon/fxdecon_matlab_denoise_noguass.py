...
denoise_data = eng.fx_decon(matlab.double(noisy_data.tolist()),matlab.double([0.001]),matlab.double([15]),matlab.double([0.01]),matlab.double([1]),matlab.double([100]));
...
# sio.savemat(('../../output/results/salt_sc100_' + 'fxdecon' + '_dn.mat'),
#                     {'data': denoise_data[:, :]})
