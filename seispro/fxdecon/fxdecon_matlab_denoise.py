...
# # file_list1='../../seismic/field/00-L120-Y.sgy' #'../data/test1.sgy' test2-Y.sgy
...
# #
# file_list='../../seismic/field/00-L120-X.sgy' #'../data/test1.sgy' test2-Y.sgy
...
denoise_data = eng.fx_decon(matlab.double(noisy_data.tolist()),matlab.double([0.004]),matlab.double([15]),matlab.double([0.01]),matlab.double([1]),matlab.double([100]));#xj 0.004
...
# show_DnNR_1x3(x=data_test,y=noisy_data,x_=denoise_data,method='fxdecon')
show_DnNR_f_1x3_(x=data_test,y=noisy_data,x_=denoise_data,method='fxdecon')
...
# show_DnNSimi_f_1x3_(x=data_test,y=noisy_data,x_=denoise_data,simi=simi.squeeze(),method='fxdecon')