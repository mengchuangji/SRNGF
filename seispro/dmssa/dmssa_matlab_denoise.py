...
# %       K:     damping factor
# %       verb:   verbosity flag (default: 0)  default: D 0.0,120.0,0.004,64,1.0,0
denoise_data = eng.fxydmssa(matlab.double(noisy_data.tolist()),0.0,100.0,0.001,64,1.0,0) #0.004
denoise_data=np.array(denoise_data)  #xinjiang:dt=0.004
elapsed_time = time.time() - start_time
print(' %10s : %2.4f second' % ('dmssa', elapsed_time))
print('haha')
...
# # show_DnNR_1x3(x=data_test,y=noisy_data,x_=denoise_data,method='dmass')
# show_DnNR_f_1x3_(x=data_test,y=noisy_data,x_=denoise_data,method='dmass')
#
...
# show_DnNSimi_f_1x3_(x=data_test,y=noisy_data,x_=denoise_data,simi=simi.squeeze(),method='dmssa')