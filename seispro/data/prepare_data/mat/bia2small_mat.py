...
def generate_patch_from_mat(dir,pch_size,stride):
    file_list = glob.glob(dir + '/*35.mat')  # get name list of all .mat files
...
def generate_patch_from_mat2(dir,pch_size,stride):
    file_list = glob.glob(dir + '/*35_gn*.mat')  # get name list of all .mat files
    file_list = sorted(file_list)  # mcj
    pch_size = pch_size
    stride = stride
    num_patch = 0
