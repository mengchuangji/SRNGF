...
path_h5=XJ_segy_dir
# path_h5 = os.path.join(path_h5, 'XJ_trn_s110_120_Patches_256_orthodmssa.hdf5')#
path_h5 = os.path.join(path_h5, 'PK_trn_Patches_256_orthodmssa.hdf5')#
num_patch = 0
import matlab.engine
import matlab
...
with h5.File(path_h5, 'w') as h5_file:
    for ii in range(len(XJ_im_list)):
        ...
        pch_dn1 = eng.fxydmssa(matlab.double(pch_noisy.tolist()), 0.0, 100.0, 0.002, 64, 1.0, 0);
        ...
        if ii == 0:
            show(pch_noisy,pch_dn,method='orthodmssa')
