...
XJ_im_list=marmousi_im_list[0:shape0_min,:,:]+XJ_noise_list[0:shape0_min,:,:]
path_h5=marmousi_im_dir
path_h5 = os.path.join(path_h5, 'marmousi20mp_tst_XJ_s110_120_noise_Patches_256_orthofxdecon.hdf5')#
