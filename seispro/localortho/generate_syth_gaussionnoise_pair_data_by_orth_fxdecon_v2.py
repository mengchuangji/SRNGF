...
from seispro.data.prepare_data.mat.bia2small_mat import generate_patch_from_mat2,generate_patch_from_noisy_mat
marmousi_im_dir = 'G:\datasets\seismic\marmousi'
#  该函数  加了  /*35.mat  /*mp
marmousi_im_list = generate_patch_from_mat2(dir=marmousi_im_dir, pch_size=256, stride=[256, 256]).squeeze()
ori_max=abs(marmousi_im_list).max()
path_h5=marmousi_im_dir
path_h5 = os.path.join(path_h5, 'marmousi35_trn_gaussian005_noise_Patches_256_orthofxdecon_1.hdf5')#
