...
PK_hdf5_path='E:\博士期间资料\田亚军\田博给的数据\盘客数据\PK_trn_Patches_256_orthodmssa.hdf5'
crop_ratio=1/2
hdf5_path_list=[PK_hdf5_path]
crop_hdf5_path='E:\博士期间资料\田亚军\田博给的数据\盘客数据\PK_trn_s21_30_Patches_256_orthodmssa.hdf5'
im_pair_list=[]
num_patch = 0
