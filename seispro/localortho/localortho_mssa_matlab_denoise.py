...
denoise_data1 = eng.fx_mssa(matlab.double(noisy_data.tolist()),1.0,100.0,0.001,64,0);
...
denoise_data2,noise_data2,low=eng.localortho(matlab.double(denoise_data1),
                                         ...
                                         matlab.double([[10, 10, 1]]),
                                         100,
                                         0.0,
                                         1, nargout=3) # 20,0,1
denoise_data=np.array(denoise_data2)
elapsed_time = time.time() - start_time
print(' %10s : %2.4f second' % ('lomssa', elapsed_time))
print('haha')
...
show_DnNR_1x3(x=data_test,y=noisy_data,x_=denoise_data,method='lo+mssa')