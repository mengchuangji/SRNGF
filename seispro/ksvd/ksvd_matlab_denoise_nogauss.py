...
y_mse = compare_mse(x, y)
print('mse_before=', '{:.4f}'.format(y_mse))
...
# show_DnNR_f_1x3_(x=data_test,y=noisy_data,x_=denoise_data,method='ksvd')
...
# show_DnNSimi_f_1x3_(x=data_test,y=noisy_data,x_=denoise_data,simi=simi.squeeze(),method='ksvd')