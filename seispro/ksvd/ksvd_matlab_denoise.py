...
# [dout,Dksvd,Gksvdc,DCT]=yc_ksvd_denoise(din,mode,l,s,perc,param)
param={'T':2.0,'niter':10.0,'mode':1.0,'K':64.0} #'K':64.0
denoise_data = eng.yc_ksvd_denoise(matlab.double(noisy_data.tolist()),1.0,matlab.double([[4,4,4]]),matlab.double([[2,2,2]]),1.0,param,nargout=1);
...
from seis_util.plotfunction import show_DnNR_3x1, show_DnNR_1x3,show_DnNR_f_1x3
# show_DnNR_3x1(x=data_test,y=noisy_data,x_=denoise_data)
show_DnNR_1x3(x=data_test,y=noisy_data,x_=denoise_data,method='ksvd')
# show_DnNR_f_1x3(x=data_test,y=noisy_data,x_=denoise_data,method='ksvd')

# from seis_util.plotfunction import show_DnNSimi_f_1x3
...
# show_DnNSimi_f_1x3(x=data_test,y=noisy_data,x_=denoise_data,simi=simi.squeeze(),method='ksvd')