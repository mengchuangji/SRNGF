...
def denoising(noise_im, clean_im, LR=1e-2, sigma=5, rho=1, eta=0.5,
    ...
    for i in range(total_step):
        ...
        with torch.no_grad():
            ...
            from seis_util.plotfunction import show_DnNR_f_1x3,show_DnNR_f_1x3_
            ...
            from seis_util.plotfunction import show_DnNSimi_f_1x3,show_DnNSimi_f_1x3_
            ...
            show_DnNSimi_f_1x3_(x=clean_im.squeeze(), y=noise_im.squeeze(), x_=torch_to_np(i0_til_torch),
                               simi=simi.squeeze(), method='GVAE+fxdecon')
